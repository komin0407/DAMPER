...
class DAMPERCapSAC(SAC):
    """Cap-only Return-Priority Two-task Gradient Surgery SAC (DAMPER-Cap).

    Identical to DAMPERSAC except for the gradient-merge geometry: instead of
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            # -----------------------------------------------------------
            # [DAMPER-Cap Actor Update -- cap-only two-task surgery]
            # -----------------------------------------------------------
