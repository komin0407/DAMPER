...
def _set_two_task_capgrad(
    ...
    Cap-only variant of the DAMPER norm-balanced merge. The temporal gradient
...
class DAMPERCapTD3(TD3):
    """Cap-only Return-Priority Two-task Gradient Surgery TD3 (DAMPER-Cap).

    Identical to DAMPERTD3 except for the gradient-merge geometry: instead of
    ...
    def __init__(
        ...
        # === [DAMPER Hyperparameters] ===
        # DAMPER is deliberately weight-free: the temporal objective is balanced
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            # -----------------------------------------------------------
            # [DAMPER-Cap Actor Update (Delayed) -- cap-only two-task surgery]
            # -----------------------------------------------------------
