...
from modules.controller import train_vanilla, train_lips_l, train_lips_g, train_caps, train_grad, train_pave, train_asap, train_damper
...
parser.add_argument(
    "--algs",
    nargs="+",
    choices=["vanilla", "lips_l", "lips_g", "caps", "grad","pave","asap","damper"],
...
pth_names = ["base_td3", "caps_td3", "grad_td3", "asap_td3","pave_td3","asap_td3","damper_td3"]
