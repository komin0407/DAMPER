#!/usr/bin/env python3
"""DAMPER-SAC trainer using the SB3-based PAVE/sac/models/damper_sac.py implementation.

SAC counterpart of train_damper_sb3.py (the TD3 version): same return-priority,
...
share a hyperparameter:
  - SiLU activation (forced by DAMPERSAC.__init__)
...
@th.no_grad()
def evaluate_policy(env_id: str, model: DAMPERSAC, validation_seeds: list[int]) -> list[dict[str, object]]:
    env = gym.make(env_id)
