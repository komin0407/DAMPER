...
share a hyperparameter:
  - SiLU activation (forced by DAMPERUnifiedSAC.__init__)
...
@th.no_grad()
def evaluate_policy(env_id: str, model: DAMPERUnifiedSAC, validation_seeds: list[int]) -> list[dict[str, object]]:
    env = gym.make(env_id)
