#!/usr/bin/env python3
"""DAMPER-TD3 (PAVE/td3/models/damper_td3.py) on Reacher-v5.

Identical hyperparameters to the Pendulum runs (train_damper_sb3.py): same
DAMPERCapTD3 class (return-priority, norm-balanced two-task PCGrad; SiLU forced;
...
from td3.models.damper_cap_td3 import DAMPERCapTD3  # noqa: E402
...
@th.no_grad()
def evaluate_policy(model: DAMPERCapTD3, validation_seeds: list[int]) -> list[dict[str, object]]:
    env = gym.make(ENV_ID)
