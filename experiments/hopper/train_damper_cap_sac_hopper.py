#!/usr/bin/env python3
"""DAMPER-Cap-SAC (PAVE/sac/models/damper_cap_sac.py) on Hopper-v5.
...
identical to train_damper_sac_hopper.py.
...
total_timesteps change (1_000_000 for Hopper, matching PAVE's Hopper schedule).
"""
