#!/usr/bin/env python3
"""DAMPER-Cap-SAC (PAVE/sac/models/damper_cap_sac.py) on Reacher-v5.
...
identical to train_damper_sac_reacher.py.

Identical hyperparameters to the Pendulum SAC run (train_damper_sac.py): same
DAMPERCapSAC class (return-priority, cap-only two-task surgery on the actor;
