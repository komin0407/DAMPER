#!/usr/bin/env python3
"""DAMPER-Cap-SAC (PAVE/sac/models/damper_cap_sac.py) on Walker2d-v5.
...
identical to train_damper_sac_walker.py.

Identical hyperparameters to the Pendulum/LunarLander/Reacher SAC runs
(train_damper_sac*.py): DAMPERCapSAC (return-priority, cap-only
two-task surgery on the actor; SiLU forced; net_arch [256,256] SB3 SAC
...
total_timesteps change (1_000_000 for Hopper, matching PAVE's Walker schedule).
"""
